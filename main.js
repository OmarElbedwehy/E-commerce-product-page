...
function addToLocal() {
    ...
    <div class="content">
            <ul>
              <li>
                <img class="main_img_" src="./images/image-product-1-thumbnail.jpg" alt="">
                <div class="text">
            ...
            <button class="check_btn">Checkout</button>
    </div>
    `
...
let mobile_imgs_srcs = [`images/image-product-1.jpg`, `images/image-product-2.jpg`, `images/image-product-3.jpg`, `images/image-product-4.jpg`];
